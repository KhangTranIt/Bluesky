...
namespace Bluesky.Core.Infrastructure.DependencyManagement
{
    public class ContainerManager
    {
        ...
        public object ResolveUnregistered(Type type, ILifetimeScope scope = null)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new BlueskyException("Unkown dependency");
            ...
            throw new BlueskyException("No contructor was found that had all the dependencies satisfied.");
        }
